...
function Pl() {
  return (
    <div className="absolute h-[22px] left-[580px] overflow-clip top-[11px] w-[90px]" data-name="pl">
      <div className="absolute bg-[rgba(255,230,0,0.15)] h-[22px] left-0 rounded-[3px] top-0 w-[90px]" data-name="bg" />
      <div className="absolute border border-[#ffe600] border-solid h-[22px] left-0 rounded-[3px] top-0 w-[90px]" data-name="bd" />
      <p className="absolute font-['IBM_Plex_Mono:Bold',sans-serif] leading-[normal] left-[10px] not-italic text-[#ffe600] text-[8px] top-[6px] whitespace-nowrap">⚠ SLIPPAGE</p>
    </div>
  );
}
...
function MonitorCard() {
  return (
    <div className="absolute bg-[#0e0b22] h-[280px] left-[320px] overflow-clip top-[76px] w-[700px]" data-name="Monitor Card">
      <div className="absolute border-[#ffe600] border-[1.5px] border-solid h-[280px] left-0 rounded-[8px] top-0 w-[700px]" data-name="mcb" />
      <div className="absolute bg-[rgba(255,230,0,0.8)] h-[3px] left-0 top-0 w-[700px]" data-name="mct" />
      ...
      <p className="absolute font-['IBM_Plex_Mono:Bold',sans-serif] leading-[normal] left-[267px] not-italic text-[#a8ff3e] text-[14px] top-[76px] whitespace-nowrap">✓</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[252px] not-italic text-[#a8ff3e] text-[8px] top-[112px] whitespace-nowrap">CONTRACT</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[252px] not-italic text-[#a8ff3e] text-[8px] top-[125px] whitespace-nowrap">AUDIT</p>
      <div className="absolute left-[400px] size-[44px] top-[62px]" data-name="Ellipse">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
          <circle cx="22" cy="22" fill="var(--fill-0, #2E7A00)" fillOpacity="0.22" id="Ellipse" r="21" stroke="var(--stroke-0, #A8FF3E)" strokeWidth="2" />
        </svg>
      </div>
      <p className="absolute font-['IBM_Plex_Mono:Bold',sans-serif] leading-[normal] left-[415px] not-italic text-[#a8ff3e] text-[14px] top-[76px] whitespace-nowrap">✓</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[400px] not-italic text-[#a8ff3e] text-[8px] top-[112px] whitespace-nowrap">x402</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[400px] not-italic text-[#a8ff3e] text-[8px] top-[125px] whitespace-nowrap">PAYMENT</p>
      <div className="absolute left-[548px] size-[44px] top-[62px]" data-name="Ellipse">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 44 44">
          <circle cx="22" cy="22" fill="var(--fill-0, #FFE600)" fillOpacity="0.22" id="Ellipse" r="21" stroke="var(--stroke-0, #FFE600)" strokeWidth="2" />
        </svg>
      </div>
      <div className="absolute left-[565px] size-[10px] top-[79px]" data-name="Ellipse">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
          <circle cx="5" cy="5" fill="var(--fill-0, #FFE600)" id="Ellipse" r="5" />
        </svg>
      </div>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[548px] not-italic text-[#ffe600] text-[8px] top-[112px] whitespace-nowrap">POST</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[548px] not-italic text-[#ffe600] text-[8px] top-[125px] whitespace-nowrap">AUDIT</p>
      ...
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[82px] not-italic text-[#a8ff3e] text-[10px] top-[204px] whitespace-nowrap">✓ 402 received · contract audit pass · risk: 0.08</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[16px] not-italic text-[#5a4a8a] text-[9px] top-[222px] whitespace-nowrap">02:14:35</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[82px] not-italic text-[#a8ff3e] text-[10px] top-[222px] whitespace-nowrap">✓ x402 payment executed — tx: 0xA4f2...8c3d</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[16px] not-italic text-[#5a4a8a] text-[9px] top-[240px] whitespace-nowrap">02:14:36</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[82px] not-italic text-[#ffe600] text-[10px] top-[240px] whitespace-nowrap">⚠ Post-audit — slippage anomaly detected</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[82px] not-italic text-[#ffe600] text-[10px] top-[258px] whitespace-pre">{`   expected: ≥ 0.000950 USDC  ·  actual: 0.000310 USDC`}</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[82px] not-italic text-[#f44] text-[10px] top-[276px] whitespace-pre">{`   slippage: 67.4%  ·  threshold: 5.0% → ESCROW HOLD triggered`}</p>
    </div>
  );
}
...
function Pl1() {
  return (
    <div className="absolute h-[22px] left-[612px] overflow-clip top-[91px] w-[48px]" data-name="pl">
...
function Pl3() {
  return (
    <div className="absolute h-[22px] left-[612px] overflow-clip top-[355px] w-[55px]" data-name="pl">
...
function LiveFeed() {
  return (
    <div className="absolute bg-[#0e0b22] h-[434px] left-[320px] overflow-clip top-[450px] w-[700px]" data-name="Live Feed">
      ...
      <div className="absolute bg-[rgba(255,230,0,0.05)] h-[132px] left-px top-[36px] w-[698px]" data-name="blk" />
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[16px] not-italic text-[#5a4a8a] text-[9px] top-[96px] whitespace-nowrap">02:14:36</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[110px] not-italic text-[#9b8ec4] text-[10px] top-[96px] whitespace-nowrap">weatherapi.eth</p>
      ...
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[16px] not-italic text-[#5a4a8a] text-[9px] top-[228px] whitespace-nowrap">02:14:33</p>
      ...
      <div className="absolute bg-[rgba(255,68,68,0.05)] h-[132px] left-px top-[300px] w-[698px]" data-name="blk" />
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[16px] not-italic text-[#5a4a8a] text-[9px] top-[360px] whitespace-nowrap">02:14:29</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[110px] not-italic text-[#9b8ec4] text-[10px] top-[360px] whitespace-nowrap">defi.hook.eth</p>
      <p className="absolute font-['IBM_Plex_Mono:Regular',sans-serif] leading-[normal] left-[360px] not-italic text-[#ffe600] text-[10px] top-[360px] whitespace-nowrap">220K USDC</p>
      <Pl3 />
    </div>
  );
}
...
function Guard() {
  return (
    <div className="absolute h-[48px] left-[12px] overflow-clip top-[772px] w-[276px]" data-name="guard">
      <div className="absolute bg-[rgba(255,230,0,0.15)] h-[48px] left-0 rounded-[8px] top-0 w-[276px]" data-name="gsbg" />
...
export default function OverviewSlippageAlert() {
  return (
    <div className="bg-[#0a0818] relative size-full" data-name="Overview — Slippage Alert">
